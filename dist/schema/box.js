...
const boxSchema = new mongoose_1.default.Schema({
    name: { type: mongoose_1.Schema.Types.String, required: true, unique: true },
    amount: { type: mongoose_1.Schema.Types.Number, required: true },
    dimension: { type: mongoose_1.Schema.Types.Mixed, required: true },
    usage: { type: mongoose_1.Schema.Types.Array },
